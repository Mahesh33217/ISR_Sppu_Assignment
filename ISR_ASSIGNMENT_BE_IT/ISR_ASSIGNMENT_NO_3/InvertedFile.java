// -------------************* Code With ArrayIndexOutOfBoundsException Error **********-----------------
...
public class InvertedFile {
    public static void main(String[] args) throws NumberFormatException, IOException {
        String fname = "";
        ArrayList<String> invertedData = new ArrayList<String>();
        ArrayList<HashSet<Integer>> docno = new ArrayList<>();
        InputStreamReader ins = new InputStreamReader(System.in);
        BufferedReader br = new BufferedReader(ins);
        System.out.println("\nENTER TOTAL NO OF FILES:");
        int no = Integer.parseInt(br.readLine());
    ...
    public static void displayIndex(ArrayList<String> invertedData, ArrayList<HashSet<Integer>> docno) {
        for (int i = 0; i < invertedData.size(); i++) {
            System.out.print(invertedData.get(i) + "\t");
            for (int doc : docno.get(i)) {
    ...
    public static void indexing(String fname, ArrayList<String> invertedData, ArrayList<HashSet<Integer>> docno, int fileno) {
        BufferedReader br;
        try {
            br = new BufferedReader(new FileReader(fname));
            String data = "", line = br.readLine();
